...
const NAV_ITEMS: NavItem[] = [
  {
    id: "overview",
    label: "Ringkasan",
    description: "Metrik utama dan pemeriksaan kesehatan",
    icon: LayoutDashboard,
  },
  {
    id: "terms",
    label: "Periode Akademik",
    description: "Kontrol semester aktif",
    icon: CalendarDays,
  },
  {
    id: "classes",
  ...
  },
  {
    id: "accounts",
    label: "Akun",
    description: "Direktori guru & siswa",
    icon: Users,
  },
  {
    id: "templates",
    label: "Template",
    description: "Template proyek & konfigurasi",
    icon: LayoutDashboard,
  },
  {
    id: "reports",
    label: "Laporan",
    description: "Ekspor dan analitik",
    icon: BarChart3,
  },
]
